...
v2.2.5 已發布(2026-07-15 hotfix:鎖檔殘留行程自動清場(CrashReportClient)+失敗訊息帶診斷尾段)。v2.2.4 同日(DD 損毀自我修復)。v2.2.3 同日(立即更新常駐)。v2.2.2 同日(hotfix:重灌 EPERM/名稱埠同步/簡中搜尋)。v2.2.1 同日發布(存檔深度整合大版本 —— 玩家/公會完整檔案(離線可查)、
